...
echo "- docs/guides/development/feature-development-standard.md - Standards"
echo
echo "📖 Documentation:"
...
alias feature-help="bash -c 'echo \"📖 See: docs/guides/development/feature-commands.md for all commands\"'"
```
