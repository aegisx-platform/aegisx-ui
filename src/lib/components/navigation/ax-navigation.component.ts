        ...
        >
          @if (item.type === 'collapsible') {
            ...
            >
              ...
              @if (state === 'expanded') {
                <span class="ax-navigation__item-title" [@fadeIn]>{{ item.title }}</span>
                @if (item.badge) {
                  <span 
            ...
            <a
              ...
              [routerLinkActive]="'ax-navigation__item--active'"
...
export class AxNavigationComponent {
  ...
  @Output() groupToggle = new EventEmitter<{ group: AxNavigationItem; isOpen: boolean }>();
