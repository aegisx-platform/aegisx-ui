 ...
 * Uses Prism.js for syntax highlighting with Catppuccin Mocha theme.
 * Supports HTML, TypeScript, SCSS, CSS, Bash, and JSON.
 */
@Component({
...
export class AxCodeTabsComponent implements AfterViewInit, OnChanges {
  ...
  @Input() set css(value: string) {
    if (value) this.addTab('CSS', value, 'css');
  }
