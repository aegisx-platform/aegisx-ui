...
// Router Animations
export const routerTransition: AnimationTriggerMetadata = trigger(
  'routerTransition',
  [
    transition('* <=> *', [
...
export const shake: AnimationTriggerMetadata = trigger('shake', [
  transition('* => *', [
    animate('0.5s', style({ transform: 'translate3d(-1px, 0, 0)' })),
    animate('0.5s', style({ transform: 'translate3d(2px, 0, 0)' })),
    animate('0.5s', style({ transform: 'translate3d(-4px, 0, 0)' })),
    animate('0.5s', style({ transform: 'translate3d(4px, 0, 0)' })),
