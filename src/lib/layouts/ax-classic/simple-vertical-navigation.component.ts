...
import { AxScrollbarDirective } from '../../directives/ax-scrollbar.directive';
...
@Component({
  ...
  imports: [
    ...
    MatIconModule,
    MatRippleModule,
    AxScrollbarDirective,
    NavigationIconComponent,
  ],
  template: `
    <div
      class="fuse-vertical-navigation-wrapper"
    ...
    >
      ...
      <div
        ...
        axScrollbar
        [axScrollbarOptions]="{ wheelPropagation: false }"
      >
              ...
              @switch (item.type) {
                @case ('group') {
                  <div class="fuse-vertical-navigation-group">
                    <div class="fuse-vertical-navigation-group-title">
                      {{ item.title }}
                    </div>
                    @if (item.children) {
    ...
    <ng-template #navigationItem let-item="item">
      <div
        ...
        [ngClass]="{
          'fuse-vertical-navigation-item-has-children': item.children,
        }"
      >
        @if (item.type === 'basic') {
          <a
          ...
          >
            ...
            @if (item.badge) {
              <span class="fuse-vertical-navigation-item-badge">
                <span [ngClass]="item.badge.classes">{{
                  item.badge.title
                }}</span>
              </span>
            }
...
export class SimpleVerticalNavigationComponent implements OnInit, OnDestroy {
  ...
  toggleCollapsable(item: AxNavigationItem): void {
    if (item.id) {
