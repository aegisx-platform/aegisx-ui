...
### Phase 1: File Structure Refactoring (2-3 hours) ✅ COMPLETED

#### Task 1.1: Separate Template to HTML File ✅ DONE

- **Description**: แยก inline template (798 lines) ไปเป็นไฟล์ HTML แยก
- **Files**:
  - Create: `pdf-templates-list.component.html` ✅
  - Modify: `pdf-templates-list.component.ts` (remove template, add templateUrl) ✅
- **Acceptance Criteria**:
  - ✅ Template ทำงานเหมือนเดิม
  - ✅ No errors in console
  - ✅ Syntax highlighting ทำงานใน HTML file
- **Estimated Time**: 30 minutes
- **Actual Time**: 20 minutes
- **Status**: ✅ COMPLETED

#### Task 1.2: Separate Styles to SCSS File ✅ DONE

- **Description**: แยก inline styles (600+ lines) ไปเป็นไฟล์ SCSS แยก
- **Files**:
  - Create: `pdf-templates-list.component.scss` ✅
  - Modify: `pdf-templates-list.component.ts` (remove styles, add styleUrls) ✅
- **Acceptance Criteria**:
  - ✅ Styles apply correctly
  - ✅ No visual regressions
  - ✅ SCSS nesting และ variables ใช้ได้
- **Estimated Time**: 30 minutes
- **Actual Time**: 15 minutes
- **Status**: ✅ COMPLETED

#### Task 1.3: Create Sub-Component Structure ⏭️ SKIPPED

- **Description**: สร้างโครงสร้างโฟลเดอร์สำหรับ sub-components
- **Files**:
  - Create: `components/template-card/` directory
  - Create: `components/template-filters/` directory
- **Acceptance Criteria**:
  - ✅ Folder structure สร้างเสร็จ
  - ✅ Placeholder components สร้างเสร็จ
- **Estimated Time**: 15 minutes
- **Status**: ⏭️ SKIPPED (will do in Phase 3)

#### Task 1.4: Verify Refactoring ⏸️ PARTIAL

- **Description**: ทดสอบว่า refactoring ไม่ทำให้อะไรเสีย
- **Tests**:
  - Manual testing: All features work
  - Check console: No errors
  - Check styles: All styles apply correctly
- **Acceptance Criteria**:
  - ⏸️ ทุกอย่างทำงานเหมือนเดิม (need manual testing)
  - ⏸️ No regressions (need manual testing)
- **Estimated Time**: 15 minutes
- **Status**: ⏸️ PENDING MANUAL TEST

---

### Phase 2: Dashboard Improvements (2-3 hours) ✅ COMPLETED

#### Task 2.1: Replace Total Templates Card with ax-kpi-card ✅ DONE

- **Description**: แทนที่ custom summary card ด้วย ax-kpi-card
- **Files**:
  - Modify: `pdf-templates-list.component.html` ✅
  - Modify: `pdf-templates-list.component.ts` (add AxKpiCardComponent import) ✅
- **Code**:
...
- **Acceptance Criteria**:
  - ✅ KPI card แสดงผลถูกต้อง
  - ✅ Value updates ตาม service
- **Estimated Time**: 20 minutes
- **Actual Time**: 15 minutes
- **Status**: ✅ COMPLETED

#### Task 2.2: Replace Active Templates Card (Clickable) ✅ DONE

- **Description**: แทนที่ active count card ด้วย clickable ax-kpi-card
- **Files**:
  - Modify: `pdf-templates-list.component.html` ✅
- **Code**:
...
#### Task 2.3: Replace Starter Templates Card (Clickable) ✅ DONE

- **Description**: แทนที่ starters count card ด้วย clickable ax-kpi-card
- **Files**:
  - Modify: `pdf-templates-list.component.html` ✅
- **Code**:
...
- **Acceptance Criteria**:
  - ✅ Click → filter starter templates
  - ✅ Hover effect ทำงาน
- **Estimated Time**: 20 minutes
- **Actual Time**: 10 minutes
- **Status**: ✅ COMPLETED

#### Task 2.4: Replace Total Usage Card ✅ DONE

- **Description**: แทนที่ usage count card ด้วย ax-kpi-card
- **Files**:
  - Modify: `pdf-templates-list.component.html` ✅
- **Code**:
...
#### Task 2.5: Apply Responsive Grid with Tailwind ✅ DONE

- **Description**: ใช้ Tailwind grid สำหรับ dashboard
- **Files**:
  - Modify: `pdf-templates-list.component.html` ✅
  - Modify: `pdf-templates-list.component.scss` (remove custom grid CSS) ✅
- **Code**:
...
#### Task 2.6: Remove Category Breakdown & Most Used Sections 🔄 MODIFIED

- **Description**: ลบ sections ที่ไม่จำเป็นออก (ซับซ้อนเกินไป)
- **Files**:
  - Modify: `pdf-templates-list.component.html` ✅
  - Modify: `pdf-templates-list.component.scss` ✅
- **Actual Implementation**: แทนที่จะลบ เราปรับให้ใช้ `ax-card` และ `ax-badge` แทน และใช้ TailwindCSS
- **Acceptance Criteria**:
  - ✅ Category Breakdown ใช้ ax-card + ax-badge
  - ✅ Most Used ใช้ ax-card
  - ✅ Responsive grid (2 columns on desktop)
  - ✅ TailwindCSS utilities ใช้ทั่วทั้งหน้า
- **Estimated Time**: 15 minutes
- **Actual Time**: 20 minutes
- **Status**: ✅ COMPLETED (แต่ปรับแนวทางแทนที่จะลบทิ้ง)

---

### Phase 3: List View Improvements (3-4 hours) ✅ COMPLETED

#### Task 3.1: Create TemplateCardComponent ✅ DONE

- **Description**: สร้าง reusable card component สำหรับแต่ละ template
- **Files**:
...
- **Acceptance Criteria**:
  - ✅ Component สร้างเสร็จ
  - ✅ Inputs/Outputs ทำงาน
  - ✅ Standalone component
- **Estimated Time**: 30 minutes
- **Actual Time**: 20 minutes
- **Status**: ✅ COMPLETED

#### Task 3.2: Implement Card Layout with aegisx-ui ✅ DONE

- **Description**: สร้าง card layout ใช้ ax-card, ax-badge, ax-field-display
- **Files**:
...
#### Task 3.3: Replace Table with Card Grid ✅ DONE

- **Description**: แทนที่ mat-table ด้วย card grid
- **Files**:
  - Modify: `pdf-templates-list.component.html`
- **Code**:
...
#### Task 3.4: Add View Toggle (Grid/Table) ✅ DONE

- **Description**: เพิ่มปุ่ม toggle ระหว่าง grid view และ table view
- **Files**:
  - Modify: `pdf-templates-list.component.html`
...
- **Acceptance Criteria**:
  - ✅ Toggle ทำงาน
  - ✅ Default = grid
  - ✅ Table view ยังใช้ได้
- **Estimated Time**: 30 minutes
- **Actual Time**: 20 minutes
- **Status**: ✅ COMPLETED

#### Task 3.5: Add Bulk Selection to Card View ✅ DONE

- **Description**: เพิ่ม checkbox สำหรับ bulk selection ใน card view
- **Files**:
  - Modify: `components/template-card/template-card.component.html`
...
### Phase 4: Search & Filters Enhancement (2-3 hours) ❌ NOT STARTED

#### Task 4.1: Refactor Search Bar with TailwindCSS

- **Description**: ปรับ search bar ให้ใช้ Tailwind layout
- **Files**:
  - Modify: `pdf-templates-list.component.html`
...
- **Description**: ทำ advanced filters เป็น collapsible panel
- **Files**:
  - Modify: `pdf-templates-list.component.html`
- **Code**:
...
- **Acceptance Criteria**:
  - ✅ Panel collapsible
  - ✅ Badge แสดงจำนวน active filters
  - ✅ Responsive grid
- **Estimated Time**: 30 minutes

#### Task 4.3: Replace Filter Chips with ax-badge

- **Description**: ใช้ ax-badge แทน mat-chip สำหรับ active filters
- **Files**:
  - Modify: `pdf-templates-list.component.html`
- **Code**:
...
- **Description**: เพิ่ม filters สำหรับ category และ type
- **Files**:
  - Modify: `pdf-templates-list.component.html`
...
- **Acceptance Criteria**:
  ...
  - ✅ Type filter ทำงาน
  - ✅ เพิ่ม categories ตามที่ระบุใน migration (inventory, budget)
- **Estimated Time**: 30 minutes
...
- **Description**: ใช้ ax-empty-state แทน custom empty state
- **Files**:
  - Modify: `pdf-templates-list.component.html`
- **Code**:
...
- **Description**: ปรับ permission error banner ให้สวยขึ้นด้วย Tailwind
- **Files**:
  - Modify: `pdf-templates-list.component.html`
  - Modify: `pdf-templates-list.component.scss`
- **Code**:
...
- **Description**: ปรับ loading state ให้สวยขึ้น
- **Files**:
  - Modify: `pdf-templates-list.component.html`
- **Code**:
...
- **Acceptance Criteria**:
  - ✅ Loading state สวยงาม
  - ✅ Centered properly
- **Estimated Time**: 10 minutes
- **Actual Time**: 10 minutes
- **Status**: ✅ COMPLETED

#### 🐛 Bug Fix: ax-badge API Compatibility
...
- **Root Cause**: Using incorrect property names and values
  - `variant="solid"` → should be `variant="soft"` or `variant="outlined"`
  - `color` property → should be `type` property
- **Files Fixed**:
...
- **Status**: ✅ FIXED - Build passing with exit code 0
...
- **Description**: แทนที่ custom CSS ด้วย Tailwind classes
- **Files**:
...
- **Acceptance Criteria**:
  - ✅ Custom CSS ลดลง 70%+
  - ✅ Tailwind classes ใช้งานได้
  - ✅ No visual regressions
- **Estimated Time**: 1 hour

#### Task 6.2: Add Dark Mode Support

- **Description**: เพิ่ม dark mode classes ให้ทุก elements
- **Files**:
  - Modify: `pdf-templates-list.component.html`
- **Pattern**:
...
- **Acceptance Criteria**:
  - ✅ Dark mode ทำงานทั้งหน้า
  - ✅ Colors contrast ดี
  - ✅ Test with Angular Material dark theme
- **Estimated Time**: 45 minutes

#### Task 6.3: Optimize Responsive Breakpoints

- **Description**: ตรวจสอบและปรับ responsive ให้ทำงานดีทุก breakpoints
- **Files**:
  - Modify: `pdf-templates-list.component.html`
  - Modify: `pdf-templates-list.component.scss`
- **Test Breakpoints**:
...
1. ✅ **CSS Cleanup**: Removed redundant custom CSS replaced by Tailwind utilities
...
2. ✅ **Dark Mode Enhancement**: Added comprehensive dark mode support
...
3. ✅ **Type Safety Fix**: Fixed `BadgeType` compatibility issue
...
#### ✅ Automated Testing Complete (2025-12-19 23:15)

**Unit Tests**:

- Status: ⚠️ N/A (No unit tests exist for PDF templates component yet)
- Action: Manual testing only

**Build Verification**:

- ✅ TypeScript Compilation: **PASSING**
- ✅ No type errors
- ⚠️ Bundle size warning (pre-existing, not blocking)
...
- ✅ `TESTING_CHECKLIST.md` - Comprehensive checklist (100+ test cases)
- ✅ `QUICK_TEST_GUIDE.md` - Quick 15-minute test guide
...
- **Description**: ทดสอบทุก features ทำงานได้ถูกต้อง
- **Test Cases**:
  - [ ] Search ทำงาน
  - [ ] Quick filters ทำงาน
  - [ ] Advanced filters ทำงาน
  - [ ] KPI cards clickable ทำงาน
  - [ ] Card view แสดงผลถูกต้อง
  - [ ] Table view (fallback) ทำงาน
  - [ ] View toggle ทำงาน
  - [ ] Bulk selection ทำงาน
  - [ ] Bulk actions ทำงาน
  - [ ] Pagination ทำงาน
  - [ ] Preview dialog ทำงาน
  - [ ] Edit dialog ทำงาน
  - [ ] Duplicate dialog ทำงาน
  - [ ] Delete ทำงาน
  - [ ] Empty state แสดงผล
  - [ ] Loading state แสดงผล
  - [ ] Permission error แสดงผล
- **Estimated Time**: 1 hour

#### Task 7.2: Responsive Testing

- **Description**: ทดสอบ responsive ทุก breakpoints
- **Devices to Test**:
  - Mobile: iPhone SE, iPhone 12, Pixel 5
  - Tablet: iPad, iPad Pro
  - Desktop: 1280px, 1440px, 1920px
- **Acceptance Criteria**:
  - ✅ Layout ถูกต้องทุกขนาด
  - ✅ No horizontal scroll
  - ✅ Readable text sizes
  - ✅ Clickable areas ใหญ่พอ (mobile)
- **Estimated Time**: 30 minutes

#### Task 7.3: Dark Mode Testing

- **Description**: ทดสอบ dark mode ทั้งหน้า
- **Test Cases**:
  - [ ] All text readable
  - [ ] Colors contrast ดี
  - [ ] Icons visible
...
- **Acceptance Criteria**:
  - ✅ Dark mode ทำงานสมบูรณ์
  - ✅ No contrast issues
- **Estimated Time**: 20 minutes

#### Task 7.4: Accessibility Testing

- **Description**: ทดสอบ accessibility
...
- **Description**: แก้ bugs และ polish UI
- **Activities**:
...
| --------------------- | ------------ | ------------------------- | --------------- | ------------------- |
| 1. File Refactoring   | 4 tasks      | ✅ COMPLETED (3/4)        | 2-3 hours       | ~1 hour             |
| 2. Dashboard          | 6 tasks      | ✅ COMPLETED              | 2-3 hours       | ~1.5 hours          |
| 3. List View          | 5 tasks      | ✅ COMPLETED              | 3-4 hours       | ~1.5 hours          |
| 4. Search & Filters   | 4 tasks      | ❌ NOT STARTED            | 2-3 hours       | -                   |
| 5. Empty/Error States | 3 tasks      | ✅ COMPLETED              | 1 hour          | ~30 mins            |
| 6. TailwindCSS        | 3 tasks      | ✅ COMPLETED              | 1-2 hours       | ~55 mins            |
| 7. Testing            | 6 tasks      | ❌ NOT STARTED            | 2-3 hours       | -                   |
...
- **Phase 2**: All 6 tasks (Dashboard Improvements with aegisx-ui) - 6/6 tasks ✅
- **Phase 3**: All 5 tasks (Card Grid View) - 5/5 tasks ✅
- **Phase 5**: All 3 tasks (Empty/Error States) - 3/3 tasks ✅
- **Phase 6**: All 3 tasks (TailwindCSS Optimization & Dark Mode) - 3/3 tasks ✅
...
3. **Test the improvements** - ลองรันและดูผลลัพธ์
