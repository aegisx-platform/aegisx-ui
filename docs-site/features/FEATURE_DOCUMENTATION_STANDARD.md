...
**Optional (create if applicable):** 5. USER_GUIDE.md - If has UI 6. DEPLOYMENT_GUIDE.md - If has special deployment needs 7. ARCHITECTURE.md - If has complex design 8. DOCUMENTATION_INDEX.md - If docs are extensive
