...
import { RealtimeUserListComponent } from '../../../shared/ui/components/realtime-user-list.component';
import { WebSocketService } from '../../../shared/business/services/websocket.service';
import { UserRealtimeStateService } from '../../../shared/business/services/user-realtime-state.service';
    ...
    <div class="realtime-demo-container p-6 max-w-6xl mx-auto">
      <mat-card appearance="outlined" class="mb-6">
        <mat-card-header>
          ...
          <mat-card-subtitle>
            Test the real-time features including WebSocket connections,
        ...
        <mat-tab label="Event Monitor">
          <div class="tab-content p-4">
            <mat-card appearance="outlined">
              ...
              <mat-card-content>
                <div
                  class="event-log max-h-96 overflow-y-auto p-4 bg-gray-50 rounded"
                >
                  <div
                  ...
                  >
                    ...
                    <p>
                      No events received yet. Connect to WebSocket and perform
                      some actions.
                    </p>
                  </div>
                </div>
          ...
          <div class="tab-content p-4">
            <mat-card appearance="outlined">
              <mat-card-header>
                ...
                <mat-card-subtitle
                  >Monitor real-time performance</mat-card-subtitle
                >
              </mat-card-header>
              <mat-card-content>
...
export class RealtimeDemoComponent implements OnInit {
  ...
  private updateMetrics(): void {
    ...
    this.eventsPerSecond = this.eventTimestamps.filter(
      (t) => t > oneSecondAgo,
    ).length;
  ...
  public async connectWebSocket(): Promise<void> {
    try {
      ...
      this.snackBar.open('Failed to connect WebSocket', 'OK', {
        duration: 3000,
      });
    }
  }
