    ...
    <div class="component-showcase">
      ...
      <div class="showcase-footer">
        <p>
          ...
          <span class="component-count">{{ totalComponentCount() }} components</span> | 
...
export class ComponentShowcaseComponent implements OnInit {
  ...
  selectTab(tabId: string) {
    ...
    this.selectedTabIndexNumber = this.filteredTabs().findIndex(tab => tab.id === tabId);
  }
