  ...
  template: `
    <div class="container mx-auto px-4 py-8">
      ...
      <ax-alert type="info" class="mb-8">
        Angular Material tables provide powerful features like sorting,
      ...
      <section class="mb-12">
        <ax-card
          ...
          subtitle="With sorting, filtering, and pagination"
          appearance="elevated"
        >
          <!-- Search Filter -->
        ...
        >
          <div class="overflow-x-auto">
            ...
            >
                ...
                <td mat-cell *matCellDef="let element">
                  <span
                    [ngClass]="{
                      ...
                      'text-yellow-600':
                        element.stock > 10 && element.stock <= 50,
              ...
              <ng-container matColumnDef="status">
                ...
                <td mat-cell *matCellDef="let element">
                  <mat-chip
                    [ngClass]="{
                      'bg-green-100 text-green-800':
                        element.status === 'in_stock',
                      'bg-yellow-100 text-yellow-800':
                        element.status === 'low_stock',
              ...
              <ng-container matColumnDef="expandedDetail">
                <td
                  ...
                  *matCellDef="let element"
                  [attr.colspan]="productColumns.length"
                >
                  <div
                    class="overflow-hidden transition-all duration-300"
                    [@detailExpand]="
                      element == expandedProduct ? 'expanded' : 'collapsed'
                    "
                  >
                    <div class="p-4 bg-gray-50 dark:bg-gray-900">
                      ...
                      <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <span class="ml-2"
                            >PRD-{{
                              element.position.toString().padStart(4, '0')
                            }}</span
                          >
                        </div>
                        <div>
              ...
              <tr
                mat-row
                *matRowDef="let element; columns: productColumns"
                class="cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800"
                (click)="
                  expandedProduct = expandedProduct === element ? null : element
                "
              ></tr>
              <tr
                mat-row
