...
export interface DrugFocusList {
  id: number;
  list_code: string;
  list_name: string;
...
export interface CreateDrugFocusListRequest {
  list_code: string;
  list_name: string;
  description?: string | null;
  generic_id?: number | null;
...
export interface UpdateDrugFocusListRequest {
  list_code?: string;
  list_name?: string;
  description?: string | null;
  generic_id?: number | null;
...
export interface ListDrugFocusListQuery {
  // Pagination
  page?: number;
  limit?: number;
  ...
  list_code?: string; // Exact match
  // String filtering for list_name
  list_name?: string; // Exact match
...
export interface ImportRowPreview extends Partial<DrugFocusList> {
  rowNumber: number;
...
export type DrugFocusListField = keyof DrugFocusList;
export type DrugFocusListSortField = DrugFocusListField;

export interface DrugFocusListListOptions {
  page?: number;
  limit?: number;
  sort?: string;
  fields?: DrugFocusListField[];
  search?: string;
}
