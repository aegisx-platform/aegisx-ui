...
@Component({
  selector: 'app-drug-focus-lists-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="list_codeFilter"
                (ngModelChange)="list_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="list_nameFilter"
                (ngModelChange)="list_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class DrugFocusListsListFiltersComponent {
  ...
  // List Code filter
  @Input() list_codeFilter = '';
  @Output() list_codeFilterChange = new EventEmitter<string>();
  // List Name filter
  @Input() list_nameFilter = '';
  @Output() list_nameFilterChange = new EventEmitter<string>();
  // Description filter
