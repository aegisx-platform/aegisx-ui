...
import { Hospital } from '../types/hospitals.types';

export interface HospitalViewDialogData {
  hospitals: Hospital;
}

@Component({
  selector: 'app-hospitals-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">Hospital Details</div>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Hospital Code</div>
            <div class="ax-dialog-field-value">
              {{ data.hospitals?.hospital_code || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Hospital Name</div>
            <div class="ax-dialog-field-value">
              {{ data.hospitals?.hospital_name || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Hospital Type</div>
            <div class="ax-dialog-field-value">
              {{ data.hospitals?.hospital_type || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Province</div>
            <div class="ax-dialog-field-value">
              {{ data.hospitals?.province || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Region</div>
            <div class="ax-dialog-field-value">
              {{ data.hospitals?.region || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Is Active</div>
            <div class="ax-dialog-field-value">
              @if (data.hospitals?.is_active) {
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content ax-dialog-section-metadata">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              <code>{{ data.hospitals?.id }}</code>
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Created At</div>
            <div class="ax-dialog-field-value">
              {{ data.hospitals?.created_at | date: 'medium' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Updated At</div>
            <div class="ax-dialog-field-value">
              {{ data.hospitals?.updated_at | date: 'medium' }}
            </div>
          </div>
        </div>
      </div>
...
export class HospitalViewDialogComponent {
  private dialogRef = inject(MatDialogRef<HospitalViewDialogComponent>);
  protected data = inject<HospitalViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.hospitals });
  }
}
