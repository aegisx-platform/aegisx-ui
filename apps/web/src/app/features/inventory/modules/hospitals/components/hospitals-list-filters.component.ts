...
@Component({
  selector: 'app-hospitals-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
      ...
      @if (showAdvancedFilters()) {
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <!-- Hospital Code Filter -->
            <mat-form-field appearance="outline" class="w-full">
              <mat-label>Hospital Code</mat-label>
              <input
                matInput
                [(ngModel)]="hospital_codeFilter"
                (ngModelChange)="hospital_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="hospital_nameFilter"
                (ngModelChange)="hospital_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="hospital_typeFilter"
                (ngModelChange)="hospital_typeFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                ...
                (ngModelChange)="provinceFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                ...
                (ngModelChange)="regionFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class HospitalsListFiltersComponent {
  ...
  // Hospital Code filter
  @Input() hospital_codeFilter = '';
  @Output() hospital_codeFilterChange = new EventEmitter<string>();
  // Hospital Name filter
  @Input() hospital_nameFilter = '';
  @Output() hospital_nameFilterChange = new EventEmitter<string>();
  // Hospital Type filter
  @Input() hospital_typeFilter = '';
  @Output() hospital_typeFilterChange = new EventEmitter<string>();
  // Province filter
  @Input() provinceFilter = '';
  @Output() provinceFilterChange = new EventEmitter<string>();
  // Region filter
  @Input() regionFilter = '';
