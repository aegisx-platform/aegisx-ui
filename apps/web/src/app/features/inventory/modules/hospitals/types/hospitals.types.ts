...
export interface ListHospitalQuery {
  // Pagination
  page?: number;
  limit?: number;
  ...
  hospital_code?: string; // Exact match
  // String filtering for hospital_name
  hospital_name?: string; // Exact match
  // String filtering for hospital_type
  hospital_type?: string; // Exact match
...
export interface ImportRowPreview extends Partial<Hospital> {
  rowNumber: number;
...
export type HospitalField = keyof Hospital;
export type HospitalSortField = HospitalField;

export interface HospitalListOptions {
  page?: number;
  limit?: number;
  sort?: string;
