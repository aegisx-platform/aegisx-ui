...
export interface UpdateAdjustmentReasonRequest {
  reason_code?: string;
  reason_name?: string;
  adjustment_type?: string | null;
  requires_approval?: boolean | null;
...
export interface ListAdjustmentReasonQuery {
  // Pagination
  page?: number;
  limit?: number;
  ...
  reason_code?: string; // Exact match
  // String filtering for reason_name
  reason_name?: string; // Exact match
...
export interface ImportRowPreview extends Partial<AdjustmentReason> {
  rowNumber: number;
...
export type AdjustmentReasonField = keyof AdjustmentReason;
export type AdjustmentReasonSortField = AdjustmentReasonField;

export interface AdjustmentReasonListOptions {
  page?: number;
  limit?: number;
  sort?: string;
  fields?: AdjustmentReasonField[];
  search?: string;
}
