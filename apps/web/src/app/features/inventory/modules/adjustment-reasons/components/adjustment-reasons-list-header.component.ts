...
@Component({
  selector: 'app-adjustment-reasons-list-header',
  standalone: true,
    ...
    <div class="flex items-start justify-between mt-4">
      <div class="flex-1">
        ...
        <p class="text-sm text-[var(--ax-text-secondary)]">
          Manage your adjustmentreason collection
        </p>
      </div>
...
export class AdjustmentReasonsListHeaderComponent {
