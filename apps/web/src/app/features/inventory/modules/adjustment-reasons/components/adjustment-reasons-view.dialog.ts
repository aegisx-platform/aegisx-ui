...
import { AdjustmentReason } from '../types/adjustment-reasons.types';

export interface AdjustmentReasonViewDialogData {
  adjustmentReasons: AdjustmentReason;
}

@Component({
  selector: 'app-adjustment-reasons-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">AdjustmentReason Details</div>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Reason Code</div>
            <div class="ax-dialog-field-value">
              {{ data.adjustmentReasons?.reason_code || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Reason Name</div>
            <div class="ax-dialog-field-value">
              {{ data.adjustmentReasons?.reason_name || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Adjustment Type</div>
            <div class="ax-dialog-field-value">
              {{ data.adjustmentReasons?.adjustment_type || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Requires Approval</div>
            <div class="ax-dialog-field-value">
              @if (data.adjustmentReasons?.requires_approval) {
          ...
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              {{ data.adjustmentReasons?.description || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Is Active</div>
            <div class="ax-dialog-field-value">
              @if (data.adjustmentReasons?.is_active) {
                <span class="ax-dialog-status-success">
                  <span class="ax-dialog-status-dot"></span>
                  Yes
                </span>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content ax-dialog-section-metadata">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              <code>{{ data.adjustmentReasons?.id }}</code>
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Created At</div>
            <div class="ax-dialog-field-value">
              {{ data.adjustmentReasons?.created_at | date: 'medium' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Updated At</div>
            <div class="ax-dialog-field-value">
              {{ data.adjustmentReasons?.updated_at | date: 'medium' }}
            </div>
          </div>
        </div>
      </div>
...
export class AdjustmentReasonViewDialogComponent {
  private dialogRef = inject(MatDialogRef<AdjustmentReasonViewDialogComponent>);
  protected data = inject<AdjustmentReasonViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.adjustmentReasons });
  }
}
