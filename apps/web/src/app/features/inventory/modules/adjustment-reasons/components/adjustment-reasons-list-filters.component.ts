...
@Component({
  selector: 'app-adjustment-reasons-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="reason_codeFilter"
                (ngModelChange)="reason_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="reason_nameFilter"
                (ngModelChange)="reason_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <mat-select
                [(ngModel)]="requires_approvalFilter"
                (ngModelChange)="requires_approvalFilterChange.emit($event)"
              >
...
export class AdjustmentReasonsListFiltersComponent {
  ...
  // Reason Code filter
  @Input() reason_codeFilter = '';
  @Output() reason_codeFilterChange = new EventEmitter<string>();
  // Reason Name filter
  @Input() reason_nameFilter = '';
  @Output() reason_nameFilterChange = new EventEmitter<string>();
  // Description filter
  @Input() descriptionFilter = '';
  @Output() descriptionFilterChange = new EventEmitter<string>();

  // Requires Approval filter
  @Input() requires_approvalFilter: boolean | undefined = undefined;
  @Output() requires_approvalFilterChange = new EventEmitter<
    boolean | undefined
  >();
  // Is Active filter
