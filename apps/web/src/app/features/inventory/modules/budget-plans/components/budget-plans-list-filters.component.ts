...
@Component({
  selector: 'app-budget-plans-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="plan_nameFilter"
                (ngModelChange)="plan_nameFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="approved_byFilter"
                (ngModelChange)="approved_byFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class BudgetPlansListFiltersComponent {
  ...
  // Plan Name filter
  @Input() plan_nameFilter = '';
  @Output() plan_nameFilterChange = new EventEmitter<string>();
  // Approved By filter
  @Input() approved_byFilter = '';
  @Output() approved_byFilterChange = new EventEmitter<string>();
