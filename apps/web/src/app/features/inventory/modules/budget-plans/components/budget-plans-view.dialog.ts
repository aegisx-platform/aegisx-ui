...
import { BudgetPlan } from '../types/budget-plans.types';

export interface BudgetPlanViewDialogData {
  budgetPlans: BudgetPlan;
}

@Component({
  selector: 'app-budget-plans-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">BudgetPlan Details</div>
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              {{ data.budgetPlans?.fiscal_year ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Department Id</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetPlans?.department_id ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Plan Name</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetPlans?.plan_name || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Total Planned Amount</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetPlans?.total_planned_amount ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Status</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetPlans?.status || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Approved At</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetPlans?.approved_at | date: 'mediumDate' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Approved By</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetPlans?.approved_by || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Is Active</div>
            <div class="ax-dialog-field-value">
              @if (data.budgetPlans?.is_active) {
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content ax-dialog-section-metadata">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              <code>{{ data.budgetPlans?.id }}</code>
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Created At</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetPlans?.created_at | date: 'medium' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Updated At</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetPlans?.updated_at | date: 'medium' }}
            </div>
          </div>
        </div>
      </div>
...
export class BudgetPlanViewDialogComponent {
  private dialogRef = inject(MatDialogRef<BudgetPlanViewDialogComponent>);
  protected data = inject<BudgetPlanViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.budgetPlans });
  }
}
