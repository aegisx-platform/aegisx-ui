...
@Component({
  selector: 'app-drug-pack-ratios-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="pack_unitFilter"
                (ngModelChange)="pack_unitFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <mat-select
                [(ngModel)]="is_defaultFilter"
                (ngModelChange)="is_defaultFilterChange.emit($event)"
              >
...
export class DrugPackRatiosListFiltersComponent {
  ...
  // Pack Unit filter
  @Input() pack_unitFilter = '';
  @Output() pack_unitFilterChange = new EventEmitter<string>();

  // Is Default filter
  @Input() is_defaultFilter: boolean | undefined = undefined;
  @Output() is_defaultFilterChange = new EventEmitter<boolean | undefined>();
  // Is Active filter
