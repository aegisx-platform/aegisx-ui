...
export interface DrugViewDialogData {
  drugs: Drug;
}

@Component({
  selector: 'app-drugs-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">Drug Details</div>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Drug Code</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.drug_code || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Trade Name</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.trade_name || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Generic Id</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.generic_id ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Manufacturer Id</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.manufacturer_id ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Tmt Tpu Id</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.tmt_tpu_id ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Nlem Status</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.nlem_status || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Drug Status</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.drug_status || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Product Category</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.product_category || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Status Changed Date</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.status_changed_date | date: 'mediumDate' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Unit Price</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.unit_price ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Package Size</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.package_size ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Package Unit</div>
            <div class="ax-dialog-field-value">
              {{ data.drugs?.package_unit || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Is Active</div>
            <div class="ax-dialog-field-value">
              @if (data.drugs?.is_active) {
...
export class DrugViewDialogComponent {
  private dialogRef = inject(MatDialogRef<DrugViewDialogComponent>);
  protected data = inject<DrugViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.drugs });
  }
}
