...
@Component({
  selector: 'app-drugs-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="drug_codeFilter"
                (ngModelChange)="drug_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="trade_nameFilter"
                (ngModelChange)="trade_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="package_unitFilter"
                (ngModelChange)="package_unitFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class DrugsListFiltersComponent {
  ...
  // Drug Code filter
  @Input() drug_codeFilter = '';
  @Output() drug_codeFilterChange = new EventEmitter<string>();
  // Trade Name filter
  @Input() trade_nameFilter = '';
  @Output() trade_nameFilterChange = new EventEmitter<string>();
  // Package Unit filter
  @Input() package_unitFilter = '';
  @Output() package_unitFilterChange = new EventEmitter<string>();
