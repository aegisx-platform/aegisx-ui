...
import { DrugComponent } from '../types/drug-components.types';

export interface DrugComponentViewDialogData {
  drugComponents: DrugComponent;
}

@Component({
  selector: 'app-drug-components-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">DrugComponent Details</div>
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              {{ data.drugComponents?.generic_id ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Component Name</div>
            <div class="ax-dialog-field-value">
              {{ data.drugComponents?.component_name || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Strength</div>
            <div class="ax-dialog-field-value">
              {{ data.drugComponents?.strength || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Strength Value</div>
            <div class="ax-dialog-field-value">
              {{ data.drugComponents?.strength_value ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Strength Unit</div>
            <div class="ax-dialog-field-value">
              {{ data.drugComponents?.strength_unit || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Is Active</div>
            <div class="ax-dialog-field-value">
              @if (data.drugComponents?.is_active) {
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content ax-dialog-section-metadata">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              <code>{{ data.drugComponents?.id }}</code>
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Created At</div>
            <div class="ax-dialog-field-value">
              {{ data.drugComponents?.created_at | date: 'medium' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Updated At</div>
            <div class="ax-dialog-field-value">
              {{ data.drugComponents?.updated_at | date: 'medium' }}
            </div>
          </div>
        </div>
      </div>
...
export class DrugComponentViewDialogComponent {
  private dialogRef = inject(MatDialogRef<DrugComponentViewDialogComponent>);
  protected data = inject<DrugComponentViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.drugComponents });
  }
}
