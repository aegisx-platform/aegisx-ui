...
export interface CreateDrugComponentRequest {
  generic_id: number;
  component_name: string;
  strength?: string | null;
  strength_value?: number | null;
...
export interface UpdateDrugComponentRequest {
  generic_id?: number;
  component_name?: string;
  strength?: string | null;
  strength_value?: number | null;
...
export interface ListDrugComponentQuery {
  // Pagination
  page?: number;
  limit?: number;
  ...
  component_name?: string; // Exact match
  // String filtering for strength
  strength?: string; // Exact match
...
export interface ImportRowPreview extends Partial<DrugComponent> {
  rowNumber: number;
...
export type DrugComponentField = keyof DrugComponent;
export type DrugComponentSortField = DrugComponentField;

export interface DrugComponentListOptions {
  page?: number;
  limit?: number;
  sort?: string;
  fields?: DrugComponentField[];
  search?: string;
}
