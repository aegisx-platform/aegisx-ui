...
@Component({
  selector: 'app-drug-components-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="component_nameFilter"
                (ngModelChange)="component_nameFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="strengthFilter"
                (ngModelChange)="strengthFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class DrugComponentsListFiltersComponent {
  ...
  // Component Name filter
  @Input() component_nameFilter = '';
  @Output() component_nameFilterChange = new EventEmitter<string>();
  // Strength filter
  @Input() strengthFilter = '';
  @Output() strengthFilterChange = new EventEmitter<string>();
  // Strength Unit filter
