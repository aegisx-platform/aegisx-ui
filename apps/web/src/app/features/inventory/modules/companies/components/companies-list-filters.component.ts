...
@Component({
  selector: 'app-companies-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="company_codeFilter"
                (ngModelChange)="company_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="company_nameFilter"
                (ngModelChange)="company_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="bank_account_numberFilter"
                (ngModelChange)="bank_account_numberFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
                placeholder="Enter bank account number"
              />
            </mat-form-field>
            <!-- Bank Account Name Filter -->
            <mat-form-field appearance="outline" class="w-full">
              <mat-label>Bank Account Name</mat-label>
              <input
                matInput
                [(ngModel)]="bank_account_nameFilter"
                (ngModelChange)="bank_account_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="contact_personFilter"
                (ngModelChange)="contact_personFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="phoneFilter"
                (ngModelChange)="phoneFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="emailFilter"
                (ngModelChange)="emailFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                ...
                (ngModelChange)="addressFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <!-- Is Vendor Filter -->
            <mat-form-field appearance="outline" class="w-full">
              <mat-label>Is Vendor</mat-label>
              <mat-select
                [(ngModel)]="is_vendorFilter"
                (ngModelChange)="is_vendorFilterChange.emit($event)"
              >
            ...
            <mat-form-field appearance="outline" class="w-full">
              <mat-label>Is Manufacturer</mat-label>
              <mat-select
                [(ngModel)]="is_manufacturerFilter"
                (ngModelChange)="is_manufacturerFilterChange.emit($event)"
              >
                <mat-option [value]="undefined">All</mat-option>
                <mat-option [value]="true">Yes</mat-option>
                <mat-option [value]="false">No</mat-option>
...
export class CompaniesListFiltersComponent {
  ...
  // Company Code filter
  @Input() company_codeFilter = '';
  @Output() company_codeFilterChange = new EventEmitter<string>();
  // Company Name filter
  @Input() company_nameFilter = '';
  @Output() company_nameFilterChange = new EventEmitter<string>();
  // Bank Account Number filter
  @Input() bank_account_numberFilter = '';
  @Output() bank_account_numberFilterChange = new EventEmitter<string>();
  // Bank Account Name filter
  @Input() bank_account_nameFilter = '';
  @Output() bank_account_nameFilterChange = new EventEmitter<string>();
  // Contact Person filter
  @Input() contact_personFilter = '';
  @Output() contact_personFilterChange = new EventEmitter<string>();
  // Phone filter
  @Input() phoneFilter = '';
  @Output() phoneFilterChange = new EventEmitter<string>();
  // Email filter
  @Input() emailFilter = '';
  @Output() emailFilterChange = new EventEmitter<string>();
  // Address filter
  @Input() addressFilter = '';
  @Output() addressFilterChange = new EventEmitter<string>();

  // Is Vendor filter
  @Input() is_vendorFilter: boolean | undefined = undefined;
  @Output() is_vendorFilterChange = new EventEmitter<boolean | undefined>();
  // Is Manufacturer filter
  @Input() is_manufacturerFilter: boolean | undefined = undefined;
  @Output() is_manufacturerFilterChange = new EventEmitter<
    boolean | undefined
  >();
  // Is Active filter
