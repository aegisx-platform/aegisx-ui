...
@Component({
  selector: 'app-departments-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">Department Details</div>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Dept Code</div>
            <div class="ax-dialog-field-value">
              {{ data.departments?.dept_code || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Dept Name</div>
            <div class="ax-dialog-field-value">
              {{ data.departments?.dept_name || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">His Code</div>
            <div class="ax-dialog-field-value">
              {{ data.departments?.his_code || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Parent Id</div>
            <div class="ax-dialog-field-value">
              {{ data.departments?.parent_id ?? '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Consumption Group</div>
            <div class="ax-dialog-field-value">
              {{ data.departments?.consumption_group || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Is Active</div>
            <div class="ax-dialog-field-value">
              @if (data.departments?.is_active) {
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content ax-dialog-section-metadata">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              <code>{{ data.departments?.id }}</code>
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Created At</div>
            <div class="ax-dialog-field-value">
              {{ data.departments?.created_at | date: 'medium' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Updated At</div>
            <div class="ax-dialog-field-value">
              {{ data.departments?.updated_at | date: 'medium' }}
            </div>
          </div>
        </div>
      </div>
...
export class DepartmentViewDialogComponent {
  private dialogRef = inject(MatDialogRef<DepartmentViewDialogComponent>);
  protected data = inject<DepartmentViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.departments });
  }
}
