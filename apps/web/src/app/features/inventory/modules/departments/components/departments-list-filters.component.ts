...
@Component({
  selector: 'app-departments-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="dept_codeFilter"
                (ngModelChange)="dept_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="dept_nameFilter"
                (ngModelChange)="dept_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="his_codeFilter"
                (ngModelChange)="his_codeFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class DepartmentsListFiltersComponent {
  ...
  // Dept Code filter
  @Input() dept_codeFilter = '';
  @Output() dept_codeFilterChange = new EventEmitter<string>();
  // Dept Name filter
  @Input() dept_nameFilter = '';
  @Output() dept_nameFilterChange = new EventEmitter<string>();
  // His Code filter
  @Input() his_codeFilter = '';
  @Output() his_codeFilterChange = new EventEmitter<string>();
