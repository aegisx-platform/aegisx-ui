...
@Component({
  selector: 'app-budget-categories-list-header',
  standalone: true,
    ...
    <div class="flex items-start justify-between mt-4">
      <div class="flex-1">
        ...
        <p class="text-sm text-[var(--ax-text-secondary)]">
          Manage your budgetcategorie collection
        </p>
      </div>
...
export class BudgetCategoriesListHeaderComponent {
