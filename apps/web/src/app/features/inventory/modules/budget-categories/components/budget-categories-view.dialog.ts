...
import { BudgetCategorie } from '../types/budget-categories.types';

export interface BudgetCategorieViewDialogData {
  budgetCategories: BudgetCategorie;
}

@Component({
  selector: 'app-budget-categories-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">BudgetCategorie Details</div>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Category Code</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetCategories?.category_code || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Category Name</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetCategories?.category_name || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Accounting Code</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetCategories?.accounting_code || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Description</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetCategories?.description || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Is Active</div>
            <div class="ax-dialog-field-value">
              @if (data.budgetCategories?.is_active) {
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content ax-dialog-section-metadata">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              <code>{{ data.budgetCategories?.id }}</code>
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Created At</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetCategories?.created_at | date: 'medium' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Updated At</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetCategories?.updated_at | date: 'medium' }}
            </div>
          </div>
        </div>
      </div>
...
export class BudgetCategorieViewDialogComponent {
  private dialogRef = inject(MatDialogRef<BudgetCategorieViewDialogComponent>);
  protected data = inject<BudgetCategorieViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.budgetCategories });
  }
}
