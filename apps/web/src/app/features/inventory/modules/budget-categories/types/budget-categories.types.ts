...
export interface CreateBudgetCategorieRequest {
  category_code: string;
  category_name: string;
  accounting_code?: string | null;
  description?: string | null;
...
export interface UpdateBudgetCategorieRequest {
  category_code?: string;
  category_name?: string;
  accounting_code?: string | null;
  description?: string | null;
...
export interface ListBudgetCategorieQuery {
  // Pagination
  page?: number;
  limit?: number;
  ...
  category_code?: string; // Exact match
  // String filtering for category_name
  category_name?: string; // Exact match
  // String filtering for accounting_code
  accounting_code?: string; // Exact match
...
export interface ImportRowPreview extends Partial<BudgetCategorie> {
  rowNumber: number;
...
export type BudgetCategorieField = keyof BudgetCategorie;
export type BudgetCategorieSortField = BudgetCategorieField;

export interface BudgetCategorieListOptions {
  page?: number;
  limit?: number;
  sort?: string;
  fields?: BudgetCategorieField[];
  search?: string;
}
