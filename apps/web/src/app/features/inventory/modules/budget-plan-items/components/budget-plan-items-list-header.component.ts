...
@Component({
  selector: 'app-budget-plan-items-list-header',
  standalone: true,
    ...
    <div class="flex items-start justify-between mt-4">
      <div class="flex-1">
        ...
        <p class="text-sm text-[var(--ax-text-secondary)]">
          Manage your budgetplanitem collection
        </p>
      </div>
...
export class BudgetPlanItemsListHeaderComponent {
