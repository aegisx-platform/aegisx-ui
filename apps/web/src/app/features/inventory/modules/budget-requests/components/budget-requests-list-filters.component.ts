...
@Component({
  selector: 'app-budget-requests-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="request_numberFilter"
                (ngModelChange)="request_numberFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="justificationFilter"
                (ngModelChange)="justificationFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="submitted_byFilter"
                (ngModelChange)="submitted_byFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
                placeholder="Enter submitted by"
              />
            </mat-form-field>
            <!-- Dept Reviewed By Filter -->
            <mat-form-field appearance="outline" class="w-full">
              <mat-label>Dept Reviewed By</mat-label>
              <input
                matInput
                [(ngModel)]="dept_reviewed_byFilter"
                (ngModelChange)="dept_reviewed_byFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
                placeholder="Enter dept reviewed by"
              />
            </mat-form-field>
            <!-- Dept Comments Filter -->
            <mat-form-field appearance="outline" class="w-full">
              <mat-label>Dept Comments</mat-label>
              <input
                matInput
                [(ngModel)]="dept_commentsFilter"
                (ngModelChange)="dept_commentsFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
                placeholder="Enter dept comments"
              />
            </mat-form-field>
            <!-- Finance Reviewed By Filter -->
            <mat-form-field appearance="outline" class="w-full">
              <mat-label>Finance Reviewed By</mat-label>
              <input
                matInput
                [(ngModel)]="finance_reviewed_byFilter"
                (ngModelChange)="finance_reviewed_byFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
                placeholder="Enter finance reviewed by"
              />
            </mat-form-field>
            <!-- Finance Comments Filter -->
            <mat-form-field appearance="outline" class="w-full">
              <mat-label>Finance Comments</mat-label>
              <input
                matInput
                [(ngModel)]="finance_commentsFilter"
                (ngModelChange)="finance_commentsFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="rejection_reasonFilter"
                (ngModelChange)="rejection_reasonFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class BudgetRequestsListFiltersComponent {
  ...
  // Request Number filter
  @Input() request_numberFilter = '';
  @Output() request_numberFilterChange = new EventEmitter<string>();
  // Justification filter
  @Input() justificationFilter = '';
  @Output() justificationFilterChange = new EventEmitter<string>();
  // Submitted By filter
  @Input() submitted_byFilter = '';
  @Output() submitted_byFilterChange = new EventEmitter<string>();
  // Dept Reviewed By filter
  @Input() dept_reviewed_byFilter = '';
  @Output() dept_reviewed_byFilterChange = new EventEmitter<string>();
  // Dept Comments filter
  @Input() dept_commentsFilter = '';
  @Output() dept_commentsFilterChange = new EventEmitter<string>();
  // Finance Reviewed By filter
  @Input() finance_reviewed_byFilter = '';
  @Output() finance_reviewed_byFilterChange = new EventEmitter<string>();
  // Finance Comments filter
  @Input() finance_commentsFilter = '';
  @Output() finance_commentsFilterChange = new EventEmitter<string>();
  // Rejection Reason filter
  @Input() rejection_reasonFilter = '';
  @Output() rejection_reasonFilterChange = new EventEmitter<string>();
  // Created By filter
