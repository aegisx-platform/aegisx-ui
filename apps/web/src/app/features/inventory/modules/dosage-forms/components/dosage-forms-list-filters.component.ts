...
@Component({
  selector: 'app-dosage-forms-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="form_codeFilter"
                (ngModelChange)="form_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="form_nameFilter"
                (ngModelChange)="form_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="form_name_enFilter"
                (ngModelChange)="form_name_enFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class DosageFormsListFiltersComponent {
  ...
  // Form Code filter
  @Input() form_codeFilter = '';
  @Output() form_codeFilterChange = new EventEmitter<string>();
  // Form Name filter
  @Input() form_nameFilter = '';
  @Output() form_nameFilterChange = new EventEmitter<string>();
  // Form Name En filter
  @Input() form_name_enFilter = '';
  @Output() form_name_enFilterChange = new EventEmitter<string>();
  // Description filter
