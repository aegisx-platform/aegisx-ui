...
import { DosageForm } from '../types/dosage-forms.types';

export interface DosageFormViewDialogData {
  dosageForms: DosageForm;
}

@Component({
  selector: 'app-dosage-forms-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">DosageForm Details</div>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Form Code</div>
            <div class="ax-dialog-field-value">
              {{ data.dosageForms?.form_code || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Form Name</div>
            <div class="ax-dialog-field-value">
              {{ data.dosageForms?.form_name || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Form Name En</div>
            <div class="ax-dialog-field-value">
              {{ data.dosageForms?.form_name_en || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Description</div>
            <div class="ax-dialog-field-value">
              {{ data.dosageForms?.description || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Is Active</div>
            <div class="ax-dialog-field-value">
              @if (data.dosageForms?.is_active) {
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content ax-dialog-section-metadata">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              <code>{{ data.dosageForms?.id }}</code>
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Created At</div>
            <div class="ax-dialog-field-value">
              {{ data.dosageForms?.created_at | date: 'medium' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Updated At</div>
            <div class="ax-dialog-field-value">
              {{ data.dosageForms?.updated_at | date: 'medium' }}
            </div>
          </div>
        </div>
      </div>
...
export class DosageFormViewDialogComponent {
  private dialogRef = inject(MatDialogRef<DosageFormViewDialogComponent>);
  protected data = inject<DosageFormViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.dosageForms });
  }
}
