...
@Component({
  selector: 'app-drug-units-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="unit_codeFilter"
                (ngModelChange)="unit_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="unit_nameFilter"
                (ngModelChange)="unit_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="unit_name_enFilter"
                (ngModelChange)="unit_name_enFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class DrugUnitsListFiltersComponent {
  ...
  // Unit Code filter
  @Input() unit_codeFilter = '';
  @Output() unit_codeFilterChange = new EventEmitter<string>();
  // Unit Name filter
  @Input() unit_nameFilter = '';
  @Output() unit_nameFilterChange = new EventEmitter<string>();
  // Unit Name En filter
  @Input() unit_name_enFilter = '';
  @Output() unit_name_enFilterChange = new EventEmitter<string>();
  // Description filter
