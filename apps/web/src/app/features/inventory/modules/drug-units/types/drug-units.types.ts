...
export interface CreateDrugUnitRequest {
  unit_code: string;
  unit_name: string;
  unit_name_en?: string | null;
  unit_type?: string | null;
...
export interface UpdateDrugUnitRequest {
  unit_code?: string;
  unit_name?: string;
  unit_name_en?: string | null;
  unit_type?: string | null;
...
export interface ListDrugUnitQuery {
  // Pagination
  page?: number;
  limit?: number;
  ...
  unit_code?: string; // Exact match
  // String filtering for unit_name
  unit_name?: string; // Exact match
  // String filtering for unit_name_en
  unit_name_en?: string; // Exact match
...
export interface ImportRowPreview extends Partial<DrugUnit> {
  rowNumber: number;
...
export type DrugUnitField = keyof DrugUnit;
export type DrugUnitSortField = DrugUnitField;

export interface DrugUnitListOptions {
  page?: number;
  limit?: number;
  sort?: string;
  fields?: DrugUnitField[];
  search?: string;
}
