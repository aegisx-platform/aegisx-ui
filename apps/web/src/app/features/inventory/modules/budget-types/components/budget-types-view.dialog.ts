...
import { BudgetType } from '../types/budget-types.types';

export interface BudgetTypeViewDialogData {
  budgetTypes: BudgetType;
}

@Component({
  selector: 'app-budget-types-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">BudgetType Details</div>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Type Code</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetTypes?.type_code || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Type Name</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetTypes?.type_name || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Budget Class</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetTypes?.budget_class || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Description</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetTypes?.description || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Is Active</div>
            <div class="ax-dialog-field-value">
              @if (data.budgetTypes?.is_active) {
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content ax-dialog-section-metadata">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              <code>{{ data.budgetTypes?.id }}</code>
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Created At</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetTypes?.created_at | date: 'medium' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Updated At</div>
            <div class="ax-dialog-field-value">
              {{ data.budgetTypes?.updated_at | date: 'medium' }}
            </div>
          </div>
        </div>
      </div>
...
export class BudgetTypeViewDialogComponent {
  private dialogRef = inject(MatDialogRef<BudgetTypeViewDialogComponent>);
  protected data = inject<BudgetTypeViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.budgetTypes });
  }
}
