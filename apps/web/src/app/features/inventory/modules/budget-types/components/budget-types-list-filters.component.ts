...
@Component({
  selector: 'app-budget-types-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="type_codeFilter"
                (ngModelChange)="type_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="type_nameFilter"
                (ngModelChange)="type_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class BudgetTypesListFiltersComponent {
  ...
  // Type Code filter
  @Input() type_codeFilter = '';
  @Output() type_codeFilterChange = new EventEmitter<string>();
  // Type Name filter
  @Input() type_nameFilter = '';
  @Output() type_nameFilterChange = new EventEmitter<string>();
  // Description filter
