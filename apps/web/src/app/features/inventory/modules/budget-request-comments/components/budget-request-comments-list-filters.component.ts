...
@Component({
  selector: 'app-budget-request-comments-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                ...
                (ngModelChange)="commentFilterChange.emit($event)"
...
export class BudgetRequestCommentsListFiltersComponent {
  ...
  // Comment filter
  @Input() commentFilter = '';
  @Output() commentFilterChange = new EventEmitter<string>();
  // Created By filter
