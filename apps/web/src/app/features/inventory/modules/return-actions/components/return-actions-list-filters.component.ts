...
@Component({
  selector: 'app-return-actions-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="action_codeFilter"
                (ngModelChange)="action_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="action_nameFilter"
                (ngModelChange)="action_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <!-- Requires Vendor Approval Filter -->
            <mat-form-field appearance="outline" class="w-full">
              <mat-label>Requires Vendor Approval</mat-label>
              <mat-select
                [(ngModel)]="requires_vendor_approvalFilter"
                (ngModelChange)="
                  requires_vendor_approvalFilterChange.emit($event)
                "
              >
...
export class ReturnActionsListFiltersComponent {
  ...
  // Action Code filter
  @Input() action_codeFilter = '';
  @Output() action_codeFilterChange = new EventEmitter<string>();
  // Action Name filter
  @Input() action_nameFilter = '';
  @Output() action_nameFilterChange = new EventEmitter<string>();
  // Description filter
  @Input() descriptionFilter = '';
  @Output() descriptionFilterChange = new EventEmitter<string>();

  // Requires Vendor Approval filter
  @Input() requires_vendor_approvalFilter: boolean | undefined = undefined;
  @Output() requires_vendor_approvalFilterChange = new EventEmitter<
    boolean | undefined
  >();
  // Is Active filter
