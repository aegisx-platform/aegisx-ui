...
import { ReturnAction } from '../types/return-actions.types';

export interface ReturnActionViewDialogData {
  returnActions: ReturnAction;
}

@Component({
  selector: 'app-return-actions-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">ReturnAction Details</div>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Action Code</div>
            <div class="ax-dialog-field-value">
              {{ data.returnActions?.action_code || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Action Name</div>
            <div class="ax-dialog-field-value">
              {{ data.returnActions?.action_name || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Action Type</div>
            <div class="ax-dialog-field-value">
              {{ data.returnActions?.action_type || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Requires Vendor Approval</div>
            <div class="ax-dialog-field-value">
              @if (data.returnActions?.requires_vendor_approval) {
          ...
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              {{ data.returnActions?.description || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Is Active</div>
            <div class="ax-dialog-field-value">
              @if (data.returnActions?.is_active) {
                <span class="ax-dialog-status-success">
                  <span class="ax-dialog-status-dot"></span>
                  Yes
                </span>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content ax-dialog-section-metadata">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              <code>{{ data.returnActions?.id }}</code>
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Created At</div>
            <div class="ax-dialog-field-value">
              {{ data.returnActions?.created_at | date: 'medium' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Updated At</div>
            <div class="ax-dialog-field-value">
              {{ data.returnActions?.updated_at | date: 'medium' }}
            </div>
          </div>
        </div>
      </div>
...
export class ReturnActionViewDialogComponent {
  private dialogRef = inject(MatDialogRef<ReturnActionViewDialogComponent>);
  protected data = inject<ReturnActionViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.returnActions });
  }
}
