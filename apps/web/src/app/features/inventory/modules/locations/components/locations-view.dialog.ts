...
export interface LocationViewDialogData {
  locations: Location;
}

@Component({
  selector: 'app-locations-view-dialog',
  standalone: true,
  ...
  template: `
    ...
    <h2 mat-dialog-title class="ax-header ax-header-neutral">
      ...
      <div class="header-text">
        <div class="ax-title">Location Details</div>
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content">
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Location Code</div>
            <div class="ax-dialog-field-value">
              {{ data.locations?.location_code || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Location Name</div>
            <div class="ax-dialog-field-value">
              {{ data.locations?.location_name || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Location Type</div>
            <div class="ax-dialog-field-value">
          ...
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Responsible Person</div>
            <div class="ax-dialog-field-value">
              {{ data.locations?.responsible_person || '-' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Is Active</div>
            <div class="ax-dialog-field-value">
              @if (data.locations?.is_active) {
      ...
      <div class="ax-dialog-section">
        ...
        <div class="ax-dialog-section-content ax-dialog-section-metadata">
          <div class="ax-dialog-field-row">
            ...
            <div class="ax-dialog-field-value">
              <code>{{ data.locations?.id }}</code>
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Created At</div>
            <div class="ax-dialog-field-value">
              {{ data.locations?.created_at | date: 'medium' }}
            </div>
          </div>
          <div class="ax-dialog-field-row">
            <div class="ax-dialog-field-label">Updated At</div>
            <div class="ax-dialog-field-value">
              {{ data.locations?.updated_at | date: 'medium' }}
            </div>
          </div>
        </div>
      </div>
...
export class LocationViewDialogComponent {
  private dialogRef = inject(MatDialogRef<LocationViewDialogComponent>);
  protected data = inject<LocationViewDialogData>(MAT_DIALOG_DATA);
  ...
  onEdit() {
    this.dialogRef.close({ action: 'edit', data: this.data.locations });
  }
}
