...
export interface ListLocationQuery {
  ...
  location_code?: string; // Exact match
  // String filtering for location_name
  location_name?: string; // Exact match
  ...
  responsible_person?: string; // Exact match
...
export interface ImportRowPreview extends Partial<Location> {
  rowNumber: number;
...
export type LocationSortField = LocationField;
