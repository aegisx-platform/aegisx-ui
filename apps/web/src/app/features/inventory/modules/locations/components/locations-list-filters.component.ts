...
@Component({
  selector: 'app-locations-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="location_codeFilter"
                (ngModelChange)="location_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="location_nameFilter"
                (ngModelChange)="location_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="responsible_personFilter"
                (ngModelChange)="responsible_personFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class LocationsListFiltersComponent {
  ...
  // Location Code filter
  @Input() location_codeFilter = '';
  @Output() location_codeFilterChange = new EventEmitter<string>();
  // Location Name filter
  @Input() location_nameFilter = '';
  @Output() location_nameFilterChange = new EventEmitter<string>();
  // Address filter
  @Input() addressFilter = '';
  @Output() addressFilterChange = new EventEmitter<string>();
  // Responsible Person filter
  @Input() responsible_personFilter = '';
  @Output() responsible_personFilterChange = new EventEmitter<string>();
