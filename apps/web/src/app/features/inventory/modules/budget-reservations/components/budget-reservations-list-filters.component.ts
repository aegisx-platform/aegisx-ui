...
@Component({
  selector: 'app-budget-reservations-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <mat-select
                [(ngModel)]="is_releasedFilter"
                (ngModelChange)="is_releasedFilterChange.emit($event)"
              >
...
export class BudgetReservationsListFiltersComponent {
  ...
  // Is Released filter
  @Input() is_releasedFilter: boolean | undefined = undefined;
  @Output() is_releasedFilterChange = new EventEmitter<boolean | undefined>();
