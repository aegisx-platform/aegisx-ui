...
@Component({
  selector: 'app-budget-reservations-list-header',
  standalone: true,
  ...
  template: `
    ...
    <div class="flex items-start justify-between mt-4">
      <div class="flex-1">
        ...
        <p class="text-sm text-[var(--ax-text-secondary)]">
          Manage your budgetreservation collection
        </p>
      </div>
    ...
    @if (!hasError) {
      ...
      >
        <ax-kpi-card
          [flat]="true"
          label="Total BudgetReservations"
          [value]="stats.total"
          variant="simple"
        ></ax-kpi-card>
...
export class BudgetReservationsListHeaderComponent {
