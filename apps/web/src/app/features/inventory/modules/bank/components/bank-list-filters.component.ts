...
@Component({
  selector: 'app-bank-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="bank_codeFilter"
                (ngModelChange)="bank_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="bank_nameFilter"
                (ngModelChange)="bank_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="swift_codeFilter"
                (ngModelChange)="swift_codeFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class BankListFiltersComponent {
  ...
  // Bank Code filter
  @Input() bank_codeFilter = '';
  @Output() bank_codeFilterChange = new EventEmitter<string>();
  // Bank Name filter
  @Input() bank_nameFilter = '';
  @Output() bank_nameFilterChange = new EventEmitter<string>();
  // Swift Code filter
  @Input() swift_codeFilter = '';
  @Output() swift_codeFilterChange = new EventEmitter<string>();
