...
export interface CreateDrugGenericRequest {
  working_code: string;
  generic_name: string;
  dosage_form?: string | null;
  strength_unit?: string | null;
...
export interface UpdateDrugGenericRequest {
  working_code?: string;
  generic_name?: string;
  dosage_form?: string | null;
  strength_unit?: string | null;
...
export interface ListDrugGenericQuery {
  // Pagination
  page?: number;
  limit?: number;
  ...
  working_code?: string; // Exact match
  // String filtering for generic_name
  generic_name?: string; // Exact match
  // String filtering for dosage_form
  dosage_form?: string; // Exact match
  // String filtering for strength_unit
  strength_unit?: string; // Exact match
  // Numeric filtering for dosage_form_id
  dosage_form_id?: number; // Exact match
  dosage_form_id_min?: number; // Range start
  dosage_form_id_max?: number; // Range end
  // Numeric filtering for strength_unit_id
  strength_unit_id?: number; // Exact match
  strength_unit_id_min?: number; // Range start
  strength_unit_id_max?: number; // Range end
  // Numeric filtering for strength_value
  strength_value?: number; // Exact match
  strength_value_min?: number; // Range start
  strength_value_max?: number; // Range end
...
export interface ImportRowPreview extends Partial<DrugGeneric> {
  rowNumber: number;
...
export type DrugGenericField = keyof DrugGeneric;
export type DrugGenericSortField = DrugGenericField;

export interface DrugGenericListOptions {
  page?: number;
  limit?: number;
  sort?: string;
  fields?: DrugGenericField[];
  search?: string;
}
