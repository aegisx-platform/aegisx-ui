...
@Component({
  selector: 'app-drug-generics-list-filters',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <div class="mt-4 pt-4 border-t border-[var(--ax-border-default)]">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="working_codeFilter"
                (ngModelChange)="working_codeFilterChange.emit($event)"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="generic_nameFilter"
                (ngModelChange)="generic_nameFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="dosage_formFilter"
                (ngModelChange)="dosage_formFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
            ...
            <mat-form-field appearance="outline" class="w-full">
              ...
              <input
                matInput
                [(ngModel)]="strength_unitFilter"
                (ngModelChange)="strength_unitFilterChange.emit($event)"
                (keyup.enter)="applyFiltersClicked.emit()"
...
export class DrugGenericsListFiltersComponent {
  ...
  // Working Code filter
  @Input() working_codeFilter = '';
  @Output() working_codeFilterChange = new EventEmitter<string>();
  // Generic Name filter
  @Input() generic_nameFilter = '';
  @Output() generic_nameFilterChange = new EventEmitter<string>();
  // Dosage Form filter
  @Input() dosage_formFilter = '';
  @Output() dosage_formFilterChange = new EventEmitter<string>();
  // Strength Unit filter
  @Input() strength_unitFilter = '';
  @Output() strength_unitFilterChange = new EventEmitter<string>();
