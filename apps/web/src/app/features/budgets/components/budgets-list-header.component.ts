...
@Component({
  selector: 'app-budgets-list-header',
  standalone: true,
  ...
  template: `
    ...
    <div class="flex items-start justify-between mt-4">
      <div class="flex-1">
        ...
        <p class="text-sm text-gray-600">Manage your budget collection</p>
      </div>
        ...
        <div class="flex items-start gap-3">
          ...
          <div class="flex-1">
            ...
            <p class=" text-sm text-red-700">
              You don't have permission to access or modify budgets.
            </p>
          </div>
          <button
      ...
      >
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
          <div class="flex items-center gap-3">
            ...
            <div>
              <div class="text-xs text-gray-500">Total Budgets</div>
...
export class BudgetsListHeaderComponent {
