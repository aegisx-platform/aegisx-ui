...
test.describe('Accessibility Tests', () => {
  ...
  test.describe('WCAG 2.1 Compliance', () => {
    ...
    test('should pass accessibility audit on dashboard page', async ({ page }) => {
    ...
    test('should pass accessibility audit on profile page', async ({ page }) => {
      await authHelper.loginAsAdmin();
    ...
    test('should pass accessibility audit on navigation', async ({ page }) => {
      await authHelper.loginAsAdmin();
      await dashboardPage.goto();
  ...
  test.describe('Keyboard Navigation', () => {
    test('should support keyboard navigation on login form', async ({ page }) => {
      ...
      await page.keyboard.press('Tab');
      const submitFocused = await page.locator('button[type="submit"]').evaluate(el => el === document.activeElement);
  ...
  test.describe('Screen Reader Compatibility', () => {
    ...
    test('should have proper button names', async ({ page }) => {
      await authHelper.loginAsAdmin();
      await dashboardPage.goto();
    ...
    test('should have proper link text', async ({ page }) => {
      ...
      for (let i = 0; i < count; i++) {
        ...
        const hasAccessibleName = (text && text.trim() && text.trim() !== 'Read more' && text.trim() !== 'Click here') || 
  ...
  test.describe('Focus Management', () => {
    ...
    test('should manage focus appropriately on page navigation', async ({ page }) => {
      await authHelper.loginAsAdmin();
      await dashboardPage.goto();
  ...
  test.describe('Dynamic Content Accessibility', () => {
    ...
    test('should handle loading states accessibly', async ({ page }) => {
      ...
      const loadingElements = page.locator('[aria-busy="true"], .loading, .spinner, [data-testid*="loading"]');
      ...
      if (count > 0) {
        ...
        expect(ariaBusy === 'true' || ariaLabel || role === 'status').toBeTruthy();
      }
    });
  });
});