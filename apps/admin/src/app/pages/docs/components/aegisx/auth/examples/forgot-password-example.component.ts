...
@Component({
  selector: 'app-forgot-password-example',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  template: `
    <div class="example-page">
      ...
      <!-- Full Page Forgot Password Example -->
      <ax-auth-layout
      ...
      <div class="demo-info-panel">
        ...
        <p>นี่คือตัวอย่างหน้า Forgot Password สำหรับ Documentation</p>
...
export class ForgotPasswordExampleComponent {
  currentState = signal<ForgotPasswordState>('idle');
  ...
  onStateChange(state: ForgotPasswordState) {
  ...
  onSubmit(data: ForgotPasswordFormData) {
    ...
    if (this.currentState() === 'idle') {
      ...
      setTimeout(() => {
        ...
        this.lastEvent.set('Reset link sent! (simulated)');
      }, 1500);
    }
  }
  ...
  onResendEmail() {
    ...
    if (this.currentState() === 'success') {
      ...
      setTimeout(() => {
        this.currentState.set('success');
        this.lastEvent.set('Reset link resent! (simulated)');
      }, 1500);
    }
  }
}
