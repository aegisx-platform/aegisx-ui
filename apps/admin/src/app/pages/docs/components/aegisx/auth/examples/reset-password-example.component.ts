...
type ResetPasswordState = 'idle' | 'loading' | 'success';

@Component({
  selector: 'app-reset-password-example',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  template: `
    <div class="example-page">
      ...
      <!-- Full Page Reset Password Example -->
      <ax-auth-layout
      ...
      <div class="demo-info-panel">
        ...
        <p>นี่คือตัวอย่างหน้า Reset Password สำหรับ Documentation</p>
...
export class ResetPasswordExampleComponent {
  currentState = signal<ResetPasswordState>('idle');
  ...
  onStateChange(state: ResetPasswordState) {
  ...
  onSubmit(data: ResetPasswordFormData) {
    ...
    if (this.currentState() === 'idle') {
      ...
      setTimeout(() => {
        ...
        this.lastEvent.set('Password reset successful! (simulated)');
      }, 1500);
    }
  }
