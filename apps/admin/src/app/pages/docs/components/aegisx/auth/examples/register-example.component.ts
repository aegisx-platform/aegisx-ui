  ...
  template: `
    <div class="example-page">
      ...
      <div class="demo-info-panel">
        ...
        <p>นี่คือตัวอย่างหน้า Register สำหรับ Documentation</p>
...
export class RegisterExampleComponent {
  currentState = signal<RegisterState>('idle');
  ...
  onStateChange(state: RegisterState) {
  ...
  onSubmit(data: RegisterFormData) {
    ...
    if (this.currentState() === 'idle') {
      ...
      setTimeout(() => {
        ...
        this.lastEvent.set('Registration successful! (simulated)');
      }, 1500);
    }
  }

  onLogin() {
    this.lastEvent.set('loginClick clicked');
  }
