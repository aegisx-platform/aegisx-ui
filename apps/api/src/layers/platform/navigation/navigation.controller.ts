...
export class NavigationController {
  ...
  async getNavigation(request: FastifyRequest, reply: FastifyReply) {
    try {
      ...
      return reply.success(
        navigationResponse,
        'Navigation structure retrieved successfully',
      );
    } catch (error) {
  ...
  async getUserNavigation(request: FastifyRequest, reply: FastifyReply) {
    try {
      ...
      const navigationResponse = await this.navigationService.getUserNavigation(
        user.id,
        {
          type,
          userId: user.id,
      ...
      return reply.success(
        navigationResponse,
        'User navigation retrieved successfully',
      );
    } catch (error) {
