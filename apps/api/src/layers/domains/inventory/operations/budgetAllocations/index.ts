...
import { BudgetAllocationsRepository } from './budget-allocations.repository';
import { budgetAllocationsRoutes } from './budget-allocations.route';
...
export default fp(
  async function budgetAllocationsDomainPlugin(
    ...
    await fastify.register(budgetAllocationsRoutes, {
      ...
      prefix: options.prefix || '/inventory/operations/budget-allocations',
    });
...
export * from './budget-allocations.schemas';
export * from './budget-allocations.types';
export { BudgetAllocationsRepository } from './budget-allocations.repository';
export { BudgetAllocationsService } from './budget-allocations.service';
export { BudgetAllocationsController } from './budget-allocations.controller';
