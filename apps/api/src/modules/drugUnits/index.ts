...
import { DrugUnitsController } from './controllers/drug-units.controller';
import { DrugUnitsService } from './services/drug-units.service';
import { DrugUnitsRepository } from './repositories/drug-units.repository';
import { drugUnitsRoutes } from './routes/index';
...
export default fp(
  async function drugUnitsDomainPlugin(
    ...
    await fastify.register(drugUnitsRoutes, {
      ...
      prefix: options.prefix || '/drug-units',
    });
...
export * from './schemas/drug-units.schemas';
export * from './types/drug-units.types';
export { DrugUnitsRepository } from './repositories/drug-units.repository';
export { DrugUnitsService } from './services/drug-units.service';
export { DrugUnitsController } from './controllers/drug-units.controller';
