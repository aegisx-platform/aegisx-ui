...
> {
  ...
  getJoinQuery() {
    return this.knex('budget_allocations').select('budget_allocations.*');
    // Add joins here if needed
    // .leftJoin('other_table', 'budget_allocations.foreign_key', 'other_table.id')
  }
  ...
  protected applyCustomFilters(
    ...
    if (filters.fiscal_year !== undefined) {
      query.where('budget_allocations.fiscal_year', filters.fiscal_year);
    }
    ...
    if (filters.budget_id !== undefined) {
      query.where('budget_allocations.budget_id', filters.budget_id);
    }
    if (filters.budget_id_min !== undefined) {
      query.where('budget_allocations.budget_id', '>=', filters.budget_id_min);
    }
    if (filters.budget_id_max !== undefined) {
      query.where('budget_allocations.budget_id', '<=', filters.budget_id_max);
    }
    if (filters.department_id !== undefined) {
      query.where('budget_allocations.department_id', filters.department_id);
    }
    if (filters.department_id_min !== undefined) {
      query.where(
        'budget_allocations.department_id',
        '>=',
    ...
    if (filters.total_budget !== undefined) {
      query.where('budget_allocations.total_budget', filters.total_budget);
    }
    ...
    if (filters.q1_budget !== undefined) {
      query.where('budget_allocations.q1_budget', filters.q1_budget);
    }
    if (filters.q1_budget_min !== undefined) {
      query.where('budget_allocations.q1_budget', '>=', filters.q1_budget_min);
    }
    if (filters.q1_budget_max !== undefined) {
      query.where('budget_allocations.q1_budget', '<=', filters.q1_budget_max);
    }
    if (filters.q2_budget !== undefined) {
      query.where('budget_allocations.q2_budget', filters.q2_budget);
    }
    if (filters.q2_budget_min !== undefined) {
      query.where('budget_allocations.q2_budget', '>=', filters.q2_budget_min);
    }
    if (filters.q2_budget_max !== undefined) {
      query.where('budget_allocations.q2_budget', '<=', filters.q2_budget_max);
    }
    if (filters.q3_budget !== undefined) {
      query.where('budget_allocations.q3_budget', filters.q3_budget);
    }
    if (filters.q3_budget_min !== undefined) {
      query.where('budget_allocations.q3_budget', '>=', filters.q3_budget_min);
    }
    if (filters.q3_budget_max !== undefined) {
      query.where('budget_allocations.q3_budget', '<=', filters.q3_budget_max);
    }
    if (filters.q4_budget !== undefined) {
      query.where('budget_allocations.q4_budget', filters.q4_budget);
    }
    if (filters.q4_budget_min !== undefined) {
      query.where('budget_allocations.q4_budget', '>=', filters.q4_budget_min);
    }
    if (filters.q4_budget_max !== undefined) {
      query.where('budget_allocations.q4_budget', '<=', filters.q4_budget_max);
    }
    if (filters.q1_spent !== undefined) {
      query.where('budget_allocations.q1_spent', filters.q1_spent);
    }
    if (filters.q1_spent_min !== undefined) {
      query.where('budget_allocations.q1_spent', '>=', filters.q1_spent_min);
    }
    if (filters.q1_spent_max !== undefined) {
      query.where('budget_allocations.q1_spent', '<=', filters.q1_spent_max);
    }
    if (filters.q2_spent !== undefined) {
      query.where('budget_allocations.q2_spent', filters.q2_spent);
    }
    if (filters.q2_spent_min !== undefined) {
      query.where('budget_allocations.q2_spent', '>=', filters.q2_spent_min);
    }
    if (filters.q2_spent_max !== undefined) {
      query.where('budget_allocations.q2_spent', '<=', filters.q2_spent_max);
    }
    if (filters.q3_spent !== undefined) {
      query.where('budget_allocations.q3_spent', filters.q3_spent);
    }
    if (filters.q3_spent_min !== undefined) {
      query.where('budget_allocations.q3_spent', '>=', filters.q3_spent_min);
    }
    if (filters.q3_spent_max !== undefined) {
      query.where('budget_allocations.q3_spent', '<=', filters.q3_spent_max);
    }
    if (filters.q4_spent !== undefined) {
      query.where('budget_allocations.q4_spent', filters.q4_spent);
    }
    if (filters.q4_spent_min !== undefined) {
      query.where('budget_allocations.q4_spent', '>=', filters.q4_spent_min);
    }
    if (filters.q4_spent_max !== undefined) {
      query.where('budget_allocations.q4_spent', '<=', filters.q4_spent_max);
    }
    if (filters.total_spent !== undefined) {
      query.where('budget_allocations.total_spent', filters.total_spent);
    }
    if (filters.total_spent_min !== undefined) {
      query.where(
        'budget_allocations.total_spent',
        '>=',
    ...
    if (filters.remaining_budget !== undefined) {
      query.where(
        'budget_allocations.remaining_budget',
    ...
    if (filters.is_active !== undefined) {
      query.where('budget_allocations.is_active', filters.is_active);
    }
  }
  ...
  protected getSortField(sortBy: string): string {
    const sortFields: Record<string, string> = {
      id: 'budget_allocations.id',
      fiscalYear: 'budget_allocations.fiscal_year',
      budgetId: 'budget_allocations.budget_id',
      departmentId: 'budget_allocations.department_id',
      totalBudget: 'budget_allocations.total_budget',
      q1Budget: 'budget_allocations.q1_budget',
      q2Budget: 'budget_allocations.q2_budget',
      q3Budget: 'budget_allocations.q3_budget',
      q4Budget: 'budget_allocations.q4_budget',
      q1Spent: 'budget_allocations.q1_spent',
      q2Spent: 'budget_allocations.q2_spent',
      q3Spent: 'budget_allocations.q3_spent',
      q4Spent: 'budget_allocations.q4_spent',
      totalSpent: 'budget_allocations.total_spent',
      remainingBudget: 'budget_allocations.remaining_budget',
      isActive: 'budget_allocations.is_active',
      createdAt: 'budget_allocations.created_at',
      updatedAt: 'budget_allocations.updated_at',
    };

    return sortFields[sortBy] || 'budget_allocations.id';
  }
  ...
  async getStats(): Promise<{
    ...
    const stats: any = await this.knex('budget_allocations')
  ...
  async createMany(
    ...
    const rows = await this.knex('budget_allocations')
  ...
  async createWithTransaction(
    ...
    return this.withTransaction(async (trx) => {
      ...
      const [row] = await trx('budget_allocations')
        .insert(transformedData)
        .returning('*');
