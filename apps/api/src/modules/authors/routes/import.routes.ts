...
export interface AuthorsImportRoutesOptions {
  controller: AuthorsController;
}

/**
 * Register authors import routes
 */
export async function authorsImportRoutes(
  fastify: FastifyInstance,
  options: AuthorsImportRoutesOptions,
) {
  ...
  fastify.get('/import/template', {
    schema: {
      ...
      description:
        'Download Excel/CSV template for authors import with field instructions and example data',
      querystring: {
        type: 'object',
        properties: {
          format: {
  ...
  fastify.post('/import/execute', {
    schema: {
      ...
      description:
        'Execute validated import using session ID from validate endpoint. Creates/updates authors in database.',
