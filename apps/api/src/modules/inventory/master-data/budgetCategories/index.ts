...
import { budgetCategoriesRoutes } from './budget-categories.route';
...
export default fp(
  async function budgetCategoriesDomainPlugin(
    ...
    await fastify.register(budgetCategoriesRoutes, {
      ...
      prefix: options.prefix || '/inventory/master-data/budget-categories',
    });
...
export * from './budget-categories.schemas';
export * from './budget-categories.types';
export { BudgetCategoriesRepository } from './budget-categories.repository';
export { BudgetCategoriesService } from './budget-categories.service';
export { BudgetCategoriesController } from './budget-categories.controller';
