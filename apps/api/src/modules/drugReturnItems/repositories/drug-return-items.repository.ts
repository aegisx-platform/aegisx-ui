...
> {
  ...
  getJoinQuery() {
    return this.knex('drug_return_items').select('drug_return_items.*');
    // Add joins here if needed
    // .leftJoin('other_table', 'drug_return_items.foreign_key', 'other_table.id')
  }
  ...
  protected applyCustomFilters(
    ...
    if (filters.return_id !== undefined) {
      query.where('drug_return_items.return_id', filters.return_id);
    }
    if (filters.return_id_min !== undefined) {
      query.where('drug_return_items.return_id', '>=', filters.return_id_min);
    }
    if (filters.return_id_max !== undefined) {
      query.where('drug_return_items.return_id', '<=', filters.return_id_max);
    }
    if (filters.drug_id !== undefined) {
      query.where('drug_return_items.drug_id', filters.drug_id);
    }
    if (filters.drug_id_min !== undefined) {
      query.where('drug_return_items.drug_id', '>=', filters.drug_id_min);
    }
    if (filters.drug_id_max !== undefined) {
      query.where('drug_return_items.drug_id', '<=', filters.drug_id_max);
    }
    if (filters.total_quantity !== undefined) {
      query.where('drug_return_items.total_quantity', filters.total_quantity);
    }
    if (filters.total_quantity_min !== undefined) {
      query.where(
        'drug_return_items.total_quantity',
        '>=',
    ...
    if (filters.good_quantity !== undefined) {
      query.where('drug_return_items.good_quantity', filters.good_quantity);
    }
    if (filters.good_quantity_min !== undefined) {
      query.where(
        'drug_return_items.good_quantity',
        '>=',
    ...
    if (filters.damaged_quantity !== undefined) {
      query.where(
        'drug_return_items.damaged_quantity',
    ...
    if (filters.lot_number !== undefined) {
      query.where('drug_return_items.lot_number', filters.lot_number);
    }
    if (filters.location_id !== undefined) {
      query.where('drug_return_items.location_id', filters.location_id);
    }
    if (filters.location_id_min !== undefined) {
      query.where(
        'drug_return_items.location_id',
        '>=',
    ...
    if (filters.action_id !== undefined) {
      query.where('drug_return_items.action_id', filters.action_id);
    }
    if (filters.action_id_min !== undefined) {
      query.where('drug_return_items.action_id', '>=', filters.action_id_min);
    }
    if (filters.action_id_max !== undefined) {
      query.where('drug_return_items.action_id', '<=', filters.action_id_max);
    }
    if (filters.notes !== undefined) {
      query.where('drug_return_items.notes', filters.notes);
    }
  }
  ...
  protected getSortField(sortBy: string): string {
    const sortFields: Record<string, string> = {
      id: 'drug_return_items.id',
      returnId: 'drug_return_items.return_id',
      drugId: 'drug_return_items.drug_id',
      totalQuantity: 'drug_return_items.total_quantity',
      goodQuantity: 'drug_return_items.good_quantity',
      damagedQuantity: 'drug_return_items.damaged_quantity',
      lotNumber: 'drug_return_items.lot_number',
      expiryDate: 'drug_return_items.expiry_date',
      returnType: 'drug_return_items.return_type',
      locationId: 'drug_return_items.location_id',
      actionId: 'drug_return_items.action_id',
      notes: 'drug_return_items.notes',
      createdAt: 'drug_return_items.created_at',
    };

    return sortFields[sortBy] || 'drug_return_items.id';
  }
  ...
  async getStats(): Promise<{
    ...
    const stats: any = await this.knex('drug_return_items')
  ...
  async createMany(data: CreateDrugReturnItems[]): Promise<DrugReturnItems[]> {
    ...
    const rows = await this.knex('drug_return_items')
  ...
  async createWithTransaction(
    ...
    return this.withTransaction(async (trx) => {
      ...
      const [row] = await trx('drug_return_items')
        .insert(transformedData)
        .returning('*');
