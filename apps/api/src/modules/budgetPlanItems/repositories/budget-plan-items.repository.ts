...
> {
  ...
  getJoinQuery() {
    return this.knex('budget_plan_items').select('budget_plan_items.*');
    // Add joins here if needed
    // .leftJoin('other_table', 'budget_plan_items.foreign_key', 'other_table.id')
  }
  ...
  protected applyCustomFilters(
    ...
    if (filters.budget_plan_id !== undefined) {
      query.where('budget_plan_items.budget_plan_id', filters.budget_plan_id);
    }
    if (filters.budget_plan_id_min !== undefined) {
      query.where(
        'budget_plan_items.budget_plan_id',
        '>=',
    ...
    if (filters.generic_id !== undefined) {
      query.where('budget_plan_items.generic_id', filters.generic_id);
    }
    if (filters.generic_id_min !== undefined) {
      query.where('budget_plan_items.generic_id', '>=', filters.generic_id_min);
    }
    if (filters.generic_id_max !== undefined) {
      query.where('budget_plan_items.generic_id', '<=', filters.generic_id_max);
    }
    if (filters.last_year_qty !== undefined) {
      query.where('budget_plan_items.last_year_qty', filters.last_year_qty);
    }
    if (filters.last_year_qty_min !== undefined) {
      query.where(
        'budget_plan_items.last_year_qty',
        '>=',
    ...
    if (filters.two_years_ago_qty !== undefined) {
      query.where(
        'budget_plan_items.two_years_ago_qty',
    ...
    if (filters.three_years_ago_qty !== undefined) {
      query.where(
        'budget_plan_items.three_years_ago_qty',
    ...
    if (filters.planned_quantity !== undefined) {
      query.where(
        'budget_plan_items.planned_quantity',
    ...
    if (filters.estimated_unit_price !== undefined) {
      query.where(
        'budget_plan_items.estimated_unit_price',
    ...
    if (filters.total_planned_value !== undefined) {
      query.where(
        'budget_plan_items.total_planned_value',
    ...
    if (filters.q1_planned_qty !== undefined) {
      query.where('budget_plan_items.q1_planned_qty', filters.q1_planned_qty);
    }
    if (filters.q1_planned_qty_min !== undefined) {
      query.where(
        'budget_plan_items.q1_planned_qty',
        '>=',
    ...
    if (filters.q2_planned_qty !== undefined) {
      query.where('budget_plan_items.q2_planned_qty', filters.q2_planned_qty);
    }
    if (filters.q2_planned_qty_min !== undefined) {
      query.where(
        'budget_plan_items.q2_planned_qty',
        '>=',
    ...
    if (filters.q3_planned_qty !== undefined) {
      query.where('budget_plan_items.q3_planned_qty', filters.q3_planned_qty);
    }
    if (filters.q3_planned_qty_min !== undefined) {
      query.where(
        'budget_plan_items.q3_planned_qty',
        '>=',
    ...
    if (filters.q4_planned_qty !== undefined) {
      query.where('budget_plan_items.q4_planned_qty', filters.q4_planned_qty);
    }
    if (filters.q4_planned_qty_min !== undefined) {
      query.where(
        'budget_plan_items.q4_planned_qty',
        '>=',
    ...
    if (filters.q1_purchased_qty !== undefined) {
      query.where(
        'budget_plan_items.q1_purchased_qty',
    ...
    if (filters.q2_purchased_qty !== undefined) {
      query.where(
        'budget_plan_items.q2_purchased_qty',
    ...
    if (filters.q3_purchased_qty !== undefined) {
      query.where(
        'budget_plan_items.q3_purchased_qty',
    ...
    if (filters.q4_purchased_qty !== undefined) {
      query.where(
        'budget_plan_items.q4_purchased_qty',
    ...
    if (filters.total_purchased_qty !== undefined) {
      query.where(
        'budget_plan_items.total_purchased_qty',
    ...
    if (filters.total_purchased_value !== undefined) {
      query.where(
        'budget_plan_items.total_purchased_value',
    ...
    if (filters.notes !== undefined) {
      query.where('budget_plan_items.notes', filters.notes);
    }
  }
  ...
  protected getSortField(sortBy: string): string {
    const sortFields: Record<string, string> = {
      id: 'budget_plan_items.id',
      budgetPlanId: 'budget_plan_items.budget_plan_id',
      genericId: 'budget_plan_items.generic_id',
      lastYearQty: 'budget_plan_items.last_year_qty',
      twoYearsAgoQty: 'budget_plan_items.two_years_ago_qty',
      threeYearsAgoQty: 'budget_plan_items.three_years_ago_qty',
      plannedQuantity: 'budget_plan_items.planned_quantity',
      estimatedUnitPrice: 'budget_plan_items.estimated_unit_price',
      totalPlannedValue: 'budget_plan_items.total_planned_value',
      q1PlannedQty: 'budget_plan_items.q1_planned_qty',
      q2PlannedQty: 'budget_plan_items.q2_planned_qty',
      q3PlannedQty: 'budget_plan_items.q3_planned_qty',
      q4PlannedQty: 'budget_plan_items.q4_planned_qty',
      q1PurchasedQty: 'budget_plan_items.q1_purchased_qty',
      q2PurchasedQty: 'budget_plan_items.q2_purchased_qty',
      q3PurchasedQty: 'budget_plan_items.q3_purchased_qty',
      q4PurchasedQty: 'budget_plan_items.q4_purchased_qty',
      totalPurchasedQty: 'budget_plan_items.total_purchased_qty',
      totalPurchasedValue: 'budget_plan_items.total_purchased_value',
      notes: 'budget_plan_items.notes',
      createdAt: 'budget_plan_items.created_at',
      updatedAt: 'budget_plan_items.updated_at',
    };

    return sortFields[sortBy] || 'budget_plan_items.id';
  }
  ...
  async getStats(): Promise<{
    ...
    const stats: any = await this.knex('budget_plan_items')
  ...
  async createMany(data: CreateBudgetPlanItems[]): Promise<BudgetPlanItems[]> {
    ...
    const rows = await this.knex('budget_plan_items')
  ...
  async createWithTransaction(
    ...
    return this.withTransaction(async (trx) => {
      ...
      const [row] = await trx('budget_plan_items')
        .insert(transformedData)
        .returning('*');
