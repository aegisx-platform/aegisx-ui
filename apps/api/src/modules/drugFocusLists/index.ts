...
import { DrugFocusListsRepository } from './repositories/drug-focus-lists.repository';
import { drugFocusListsRoutes } from './routes/index';
...
export default fp(
  async function drugFocusListsDomainPlugin(
    ...
    await fastify.register(drugFocusListsRoutes, {
      ...
      prefix: options.prefix || '/drug-focus-lists',
    });
...
export * from './schemas/drug-focus-lists.schemas';
export * from './types/drug-focus-lists.types';
export { DrugFocusListsRepository } from './repositories/drug-focus-lists.repository';
export { DrugFocusListsService } from './services/drug-focus-lists.service';
export { DrugFocusListsController } from './controllers/drug-focus-lists.controller';
