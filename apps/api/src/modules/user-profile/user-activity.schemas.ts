...
export const ActivityLogSchema = Type.Object({
  ...
  device_info: Type.Optional(Type.Object({
  ...
  location_info: Type.Optional(Type.Object({
...
export type ActivitySessionsResponse = Static<typeof ActivitySessionsResponseSchema>;
